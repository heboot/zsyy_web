<template>
    <div class="content">
        ...
        <!-- <div v-if="list.length==0" style="text-align:center;margin-top:50px; font-size:24px">暂无数据</div> -->
        <div class="listBox">
            <div class="list">
                <ul>
...
export default {
    ...
    methods: {
        ...
        // 获取试卷列表
        getList(key) {
            this.$http.post("test/question/pageQuery", {
                userCategory:localStorage.getItem("userInfo").id,
